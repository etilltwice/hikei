...
class DemoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('projects')->insert([
            ...
            [
                'name' => '環境優しい美しいドレスを作るということ',
                'caption' => 'ステラ マッカートニーは環境を大切にし、自然に逆らうことなく共生することが大切であると考えています。できるだけ多くのサステナブルな素材を供給し続けることによって、環境を豊かにし未来のために守っていきます。例えば「廃棄物」を再定義することで、この素晴らしい素材の未来を守る支援をしています。不要な害を惑星に与えることなく高級品を作ることが可能だと証明するのが目標です。他にも原始林とそこに住む生き物たちを保護しながらビスコースを調達しています。ビスコースのもととなった森は、持続可能に管理され、トレースすることも可能になっています。',
                'brand_id' => '2',
                'product_id' => '3'
            ],
            [
                'name' => '作り手を尊敬した靴作り',
                'caption' => '服を作る人々、農作物を育てる農家の人々、ステラマッカートニーの従業員そしてお客様。ファッションの未来は「人」にかかっています。頼りにする人々そして頼ってくださる人々に良い影響をもたらしたい、これがステラ マッカートニーの理念です。だからこそ、サプライチェーン内のすべての人が、敬意と尊厳を受け、適正な賃金を受け取る権利を持つと考えます。そのために望ましい仕事を供給して人々のスキルを育成し雇用者の声を強め、弱い立場の人々を擁護できるような、現代的で回復力のあるサプライチェーンを構築することが重要です。',
                'brand_id' => '2',
                'product_id' => '4'
            ]
        ]);
